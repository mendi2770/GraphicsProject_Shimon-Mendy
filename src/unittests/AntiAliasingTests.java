...
public class AntiAliasingTests {
	...
	public void test() {
		Camera camera = new Camera(new Point3D(-140, 20, 35), new Vector(1, -0.15, -0.25), new Vector(1, 0, 4))//
				.setViewPlaneSize(200, 200).setDistance(1000).setAmountOfSampledRays(0); // Turn on/off the test by
																							// changing the amount
		...
		scene.geometries.add( //
				new Geometries(
						new Polygon(new Point3D(10, 0, -10), new Point3D(0, 10, -10), new Point3D(-10, 0, -10),
								new Point3D(0, -10, -10)).setMaterial(
										new Material().setKd(0.5).setKs(0.5).setnShininess(60).setkT(0.2).setkR(0)),
						new Polygon(new Point3D(10, 0, -10), new Point3D(0, -10, -10), new Point3D(0, -10, 0),
								new Point3D(10, 0, 0)).setMaterial(
										new Material().setKd(0.5).setKs(0.5).setnShininess(60).setkT(0).setkR(1)),
						new Polygon(new Point3D(10, 0, -10), new Point3D(0, 10, -10), new Point3D(0, 10, 0),
								new Point3D(10, 0, 0))
						...
						new Polygon(new Point3D(10, 0, 0), new Point3D(0, -10, 0), new Point3D(-10, 0, 0),
								new Point3D(0, 10, 0)).setMaterial(
										new Material().setKd(0.5).setKs(0.5).setnShininess(60).setkT(0.5))),
		...
		scene.lights
				.add(new SpotLight(new Color(700, 400, 400), new Point3D(30, 30, 100), new Vector(0, 0, -1), 1, 0, 0) //
						.setkL(4E-5).setkQ(2E-7));

		scene.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(60, 60, 200), 1, 0.0005, 0.0005));

		scene.lights
				.add(new SpotLight(new Color(700, 400, 400), new Point3D(120, 120, 300), new Vector(0, 0, -1), 1, 0, 0) //
						.setkL(4E-5).setkQ(2E-7));
