...
public class PlaneTests {
	...
	public void testFindIntersections() {
		...
		assertNull("Ray's crosses the plane",
				plane.findIntersections(new Ray(new Vector(-1, 1, 0), new Point3D(1, -1, 1))));
		...
		assertNull("Ray's crosses the plane",
				plane.findIntersections(new Ray(new Vector(-3, -1, 0), new Point3D(1, -1, 1))));

		// TC16: Ray is neither orthogonal nor parallel to the plane and begins in the
		// same point
		assertNull("Ray's crosses the plane",
				plane.findIntersections(new Ray(new Vector(-3, -1, 0), new Point3D(1, 0, 0))));
	}
}
