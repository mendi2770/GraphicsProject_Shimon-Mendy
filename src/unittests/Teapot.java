...
public class Teapot {
	...
	public void teapot1() {
		scene.geometries.add( //
						new Geometries(new Triangle(pnts[7], pnts[6], pnts[1]).setEmission(color).setMaterial(mat), //
						...
						new Geometries(new Triangle(pnts[69], pnts[68], pnts[63]).setEmission(color).setMaterial(mat), //
						...
						new Geometries(new Triangle(pnts[50], pnts[117], pnts[121]).setEmission(color).setMaterial(mat), //
