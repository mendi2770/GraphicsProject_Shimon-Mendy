...
public class ShadowTests {
	...
	public void sphereTriangleMovementInitial1() {
		scene.geometries.add( //
				new Sphere(new Point3D(0, 0, -200), 60) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setnShininess(30)), //
				new Triangle(new Point3D(-50, -20, 20), new Point3D(-20, -50, 20), new Point3D(-48, -48, 16)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setnShininess(30)) //
		);
		scene.lights.add( //
	...
	public void sphereTriangleInitialLight1() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100, -100, 245), new Vector(1, 1, -3), 1, 0, 0) //
						.setkL(1E-5).setkQ(1.5E-7));
	...
	public void sphereTriangleInitialLight2() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-80, -80, 200), new Vector(1, 1, -3), 1, 0, 0) //
						.setkL(1E-5).setkQ(1.5E-7));
